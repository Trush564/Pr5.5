...
public class Main {
    public static void main(String[] args) {
        ...
        s4 = sc.next();
        s5 = sc.next();
        s6 = s1.concat(" ").concat(s2).concat(" ").concat(s3).concat(" ").concat(s4).concat(" ").concat(s5);
        ...
        f4 = fg.next();
        f5 = fg.next();
        f6 = f1.substring(0,1)+f2.substring(0,1)+f3.substring(0,1)+f4.substring(0,1)+f5.substring(0,1);
